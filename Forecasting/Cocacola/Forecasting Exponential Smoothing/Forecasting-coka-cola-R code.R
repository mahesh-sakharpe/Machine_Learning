#### Forcasting Exponential Smoothing Prediction - Cocacola #####
...
df_cocacola <- readxl::read_excel(file.choose())
View(df_cocacola)
library(tseries)

# Converting data into time series object
cocacola <- ts(df_cocacola$Sales,frequency = 4,start = c(86))
View(cocacola)
...
plot(cocacola) # Visualization shows that it has level,trend, seasonality => Additive Seasonality
