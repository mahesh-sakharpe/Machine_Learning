#### Forcasting Exponential Smoothing Prediction - Airline Dataset #####
...
df_airline <- readxl::read_xlsx(file.choose())
View(df_airline)
library(tseries)

# Converting data into time series object
airline <- ts(df_airline$Passengers,frequency = 4,start = c(95))
View(airline)
...
plot(airline) # Visualization shows that it has level,trend and fluctuate with seasonality change
